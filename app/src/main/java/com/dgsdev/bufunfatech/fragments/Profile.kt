...
import com.dgsdev.bufunfatech.MainActivity
import com.dgsdev.bufunfatech.R
import com.dgsdev.bufunfatech.databinding.FragmentProfileBinding
...
class Profile : Fragment() {
    ...
    private fun setData() {
        ...
        binding.monthlyBudget.text = "R$ $monthlyBudget"
        binding.yearlyBudget.text = "R$ $yearlyBudget"
        ...
        binding.rateUs.setOnClickListener{
            try {
                startActivity(
                    Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("market://details?id=br.com.fiap.fiapon&hl=pt_BR&gl=US")
                    )
                )
                ...
                startActivity(
                    Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://github.com/dgsdev")
                    )
                )
            }
        }
        ...
        binding.aboutUs.setOnClickListener {
            Toast.makeText(
                requireActivity(),
                "Trabalhando nisso aguarde atualização",
                Toast.LENGTH_SHORT
            ).show()
        }
    ...
    private fun openEditDialog(monthlyBudget: String?,yearlyBudget: String?) {
        ...
        update?.setOnClickListener {
            ...
            if(monthly_budget == "" || yearly_budget == "") {
                Toast.makeText(requireActivity(), "Nome e orçamento não podem ficar vazios......", Toast.LENGTH_SHORT).show()
            }else{
                val editor: SharedPreferences.Editor = userDetails.edit()
    ...
    private fun fingerPrintSensor() {
        ...
        val biometricPrompt = BiometricPrompt.Builder(requireActivity())
            ...
            .setTitle("Requer sua Autentificação")
            .setDescription("Por favor insira o seu PIN / senha para continuar")
            .build()
    ...
    private fun checkBiometricSupport(): Boolean {
        ...
        if (!keyguardManager.isKeyguardSecure){
            notifyUser("Impressão digital não ativada nas configurações")
            return false
        }
