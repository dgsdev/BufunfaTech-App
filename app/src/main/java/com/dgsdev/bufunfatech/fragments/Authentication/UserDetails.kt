...
import com.dgsdev.bufunfatech.databinding.FragmentUserDetailsBinding
...
class UserDetails : Fragment() {
    ...
    private fun setData() {
        ...
        binding.text1.text = "Vamos começar rm93863!"
        //binding.text1.text = "Vamos começar \n${name[0]} !!"
    ...
    private fun saveUserData() {
        ...
        if(monthly_budget.equals("") || yearly_budget.text.toString().equals("")) {
            Toast.makeText(requireActivity(), "Insira todos os detalhes para continuar...", Toast.LENGTH_SHORT).show()
        }else{
